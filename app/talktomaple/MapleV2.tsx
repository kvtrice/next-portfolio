      ...
      <div className='grid md:grid-cols-2 gap-4 justify-center items-center py-5 bg-white rounded-xl'>
        ...
        <div className='flex flex-col justify-center items-center'>
          <Image
            ...
            className='object-fit max-h-[550px] w-auto'
          />
          <figcaption className='mb-10'>Home Screen + Companion</figcaption>
        </div>
        <div className='flex flex-col justify-center items-center'>
          <Image
            src={im14}
        ...
        <div className='flex flex-col justify-center items-center'>
          <Image
            ...
            className='object-fit max-h-[550px] w-auto'
          />
          <figcaption className='mb-10'>Journal Prompt Screen</figcaption>
        </div>
        <div className='flex flex-col justify-center items-center'>
          <Image
            src={im16}
            ...
            className='object-fit max-h-[550px] w-auto'
          />
          <figcaption className='mb-10'>Response time notification</figcaption>
        </div>
        <div className='flex flex-col justify-center items-center'>
          <Image
            src={im17}
            ...
            className='object-fit max-h-[550px] w-auto'
          />
          <figcaption className='mb-10'>Red flag capture message</figcaption>
        </div>
        <div className='flex flex-col justify-center items-center'>
          <Image
            src={im18}
